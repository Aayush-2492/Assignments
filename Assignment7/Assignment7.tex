...
f_{X}(x)=
 \begin{cases} 
      \lambda_X \cdot e^{-\lambda_X \cdot x} & x \geq 0 \\
      0 & otherwise
 \end{cases}
\end{align}
...
f_{Y}(y)=
 \begin{cases} 
      \lambda_Y \cdot e^{-\lambda_Y \cdot y} & y \geq 0 \\
      0 & otherwise
 \end{cases}
 \end{align}
...
\begin{align}
    ...
    \\
    &=(F_X(z)-F_X(0))\cdot (F_Y(z)-F_Y(0))
    \\
    &=1+e^{-(\lambda_X)\cdot z}+e^{-(\lambda_X)\cdot z}-e^{-(\lambda_X+\lambda_Y)\cdot z}
\end{align}
$P(Z\geq z)$ denotes the probability that the lifetime of the system is $z$.\\
\begin{equation}
    P(Z\geq z)  = e^{-(\lambda_X+\lambda_Y)\cdot z}-e^{-(\lambda_X)\cdot z}-e^{-(\lambda_X)\cdot z}
\end{equation}
Let V be a random variable such that V represents the lifetime of the system.
\begin{equation}
    P(V=v)=e^{-(\lambda_X+\lambda_Y)\cdot v}-e^{-(\lambda_X)\cdot v}-e^{-(\lambda_X)\cdot v}
\end{equation}
\begin{align}
    E(V) &= \int_{0}^{\infty}P(V=v) \,dv
    \\
    &=\int_{0}^{\infty}(e^{-(\lambda_X+\lambda_Y)\cdot v}-e^{-(\lambda_X)\cdot v}-e^{-(\lambda_X)\cdot v}) \,dv
    \\
