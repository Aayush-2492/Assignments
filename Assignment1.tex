...
\section*{Solution}
Probability of getting a defective bulb $= p = \dfrac{10}{100} = \dfrac{1}{10}$\\\\
Let $q$ be the probability of not finding a defective bulb. By Complement Law,\\\\
$q = 1-p = \dfrac{9}{10}$\\\\
...
$P(X=0) = \binom{5}{0} p^{0} q^{5}$ = Probability of finding zero defective bulbs\\\\
Substituting values of $p$ and $q$, we get,\\\\
$P(X=0) = \left(\frac{9}{10}\right)^5$\\\\
Therefore, Required probability $$= \left(\frac{9}{10}\right)^5$$
