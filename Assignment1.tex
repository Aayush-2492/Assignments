...
$q = 1-p = \dfrac{9}{10}$\\\\
Let X be the number of defective bulbs out of a sample of five bulbs\\\\
$P(X=x) = \binom{5}{x} p^{x} q^{5-x}$\\\\
$P(X=0) = \binom{5}{0} p^{0} q^{5}$\\\\
$P(X=0) = (\dfrac{9}{10})^5$\\\\
Therefore, Required probability $$= (\dfrac{9}{10})^5$$
