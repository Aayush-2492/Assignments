...
\begin{align}
\nonumber    Var(\dfrac{X}{\sigma_X}\pm\dfrac{Y}{\sigma_Y}) &= Var(\dfrac{X}{\sigma_X})+Var(\dfrac{\pm Y}{\sigma_Y})\\
    &+2Cov(\dfrac{X}{\sigma_X},\dfrac{\pm Y}{\sigma_Y})\\
\nonumber    &=\dfrac{1}{{\sigma_X}^2}Var(X)+\dfrac{1}{{\sigma_Y}^2}Var(Y)\\
    &+2 Cov(\dfrac{X}{\sigma_X},\dfrac{\pm Y}{\sigma_Y})\\\\
    &=2\pm2\dfrac{Cov(X,Y)}{{\sigma_X}{\sigma_Y}}
\end{align}
Since Variance is always positive,
\begin{align}
    Var(\dfrac{X}{\sigma_X}\pm\dfrac{Y}{\sigma_Y})\geq 0
    \\[6pt]
...
\begin{align}
    ...
    0\leq E(XY)\leq12
\end{align}
\textbf{Therefore, Option B is correct.}\\
Now,
\begin{align}
    E(X+Y)^2 &= E(X^2)+E(Y^2)+2E(XY)\\
    E(X+Y)^2 &= 26+2E(XY)
\end{align}
From equation 0.0.16,
\begin{equation}
